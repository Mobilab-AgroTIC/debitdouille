...
// Flowmeter
const byte debitmetre1 = 4; // broche utilisée pour déclencher l'interruption du debitmètre 1
const byte debitmetre2 = 5; // broche utilisée pour déclencher l'interruption du debitmètre 1
